                ...
                <div class="quality__container container">
                    ...
                    <div class="quality__content grid">
                        <div class="quality__images">
                            <img src="assets/img/blog4.png" alt="" class="quality__img-big">
                            <img src="assets/img/quality2.png" alt="" class="quality__img-small">
                        </div>

                        <div class="quality__data">
                            <h1 class="quality__title">  الحصص التدربية  </h1>
                            
                            <span class="quality__special">نادي نسائي متكامل</span>
                            <p class="quality__description">
                                أعطي جسمك العناية التي يستحقها ولاحظي نتائج حقيقية من خلال التمارين المتواصلة، الصبر والمثابرة.
                            </p>

                            <a href="reigistratio-c.php">
                            <p class="quality__description">
                                اشترك الان
                            </p>
                            </a>
